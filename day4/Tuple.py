...
#Example6: Check if Item Exists( searching of item in tup
#mytuple=("apple", "banana", "cherry")
...
# print("no, banana is not present")
 ...
 # Example8: Add items to tuple not possible bcoz tuple is immutable - cannot change values/items #mytuple=("apple", "banana", "cherry")
